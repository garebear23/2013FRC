...
class Robot:
    ...
    def Init():
        ...
        Robot.discOut = wpilib.DigitalInput(6)
        Robot.discOutCounter = wpilib.Counter(Robot.discOut)
        Robot.discIn = wpilib.DigitalInput(8)
        ...
        Robot.shooterPiston = wpilib.DoubleSolenoid(5, 6)
